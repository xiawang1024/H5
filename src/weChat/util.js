...
const LINK = 'https://a.weixin.hndt.com/h5/999/20180714/index.html';
...
class WeChatConf extends WeChat {
	constructor(props) {
		super(props);
		this.title = '洛阳白云山杯999的足球宝贝总决赛正在直播';
		this.link = LINK; //分享链接
		this.img_url = 'http://www.hndt.com/fm/999/res/bmdxcvAc.png?1504578961695';
