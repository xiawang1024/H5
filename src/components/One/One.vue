...
.one {
  ...
  .g-body {
    ...
    .m-logo {
      ...
      width: 100%;
      height: 133px;
      background: url('../common/icon-gcd.png') center center no-repeat;
    ...
    .m-title {
      ...
      width: 100%;
      height: 151px;
      background: url('../common/icon-title.png') center center no-repeat;
      background-size: contain;
    }
    ...
    .m-body {
      ...
      .u-theme {
        ...
        font-size: 28px;
        font-weight: bold;
        background: url('./icon-titlec.png') center center no-repeat;
        background-size: contain;
