<template>
  <div class="xin-wen">
    ...
    <div :class="[{'text-wrap':true},topClass]">
      ...
      >{{showData.title}}</h3>
      <p
        :class="{desc:true,noTitle:noTitle,ani:true}"
        swiper-animate-effect="fadeInLeft"
        swiper-animate-duration="0.6s"
        swiper-animate-delay="0.25s"
      >
        <span class="icon"></span>
        <span class="text">{{showData.subTitle}}</span>
      </p>
    </div>
    <Voice
      v-if='showData.audio'
    ...
    ></Voice>
    <div
      :class="[{'img-wrap':true,'ani':true},topClass]"
      swiper-animate-effect="fadeIn"
      swiper-animate-duration="0.6s"
      swiper-animate-delay="0.4s"
    >
      <img
        v-for="(item,index) of showData.imgObj"
...
<script>
import Voice from "../Vioce/index.vue";
export default {
  name: "XinWen",
  components: {
    Voice
