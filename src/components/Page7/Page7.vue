    ...
    <div class="host2">
        ...
        <div class="g-body">
          <div class="info-wrap">
            ...
            <div class="text-wrap">
              <h3 class="name">男女声二重唱：《入党申请书》</h3>
              <p class="desc">词：贺沛轩  曲：方  岩</p>
              <p class="desc">演唱：河南歌舞演艺集团歌剧团</p>
              <p class="desc">郑州升达大学、青年歌手  郭亚琼</p>
              <p class="desc">青年歌唱家  燕  峰</p>

            </div>
            <div class="avatar-wrap">
              <img src="./host-1.png" alt="" class="avatar">
              <img src="./host-3.png" alt="" class="avatar1">
            </div>
          </div>
          ...
          <div class="info-wrap">
            ...
            <div class="text-wrap">
              <h3 class="name">女声独唱：《江山》</h3>

              <p class="desc">词：晓  光  曲：印  青</p>
              <p class="desc">演唱：郑州师范学院</p>
              <p class="desc">青年女高音歌唱家  张伟芳</p>
            </div>
            <div class="avatar-wrap">
