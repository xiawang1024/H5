    ...
    <div class="host2">
        ...
        <div class="g-body">
          <div class="info-wrap">
            ...
            <div class="text-wrap">
              <h3 class="name">女声二重唱：《映山红》</h3>

              <p class="desc">词：陆柱国  曲：傅庚辰</p>
              <p class="desc">演唱：河南广播电视台音乐广播   王  皎  李  江</p>
          ...
          <div class="info-wrap">
            ...
            <div class="text-wrap">
              <h3 class="name">女声独唱：《情深意长》</h3>
              <p class="desc">词：王印泉  曲：臧东升 </p>
              <p class="desc">演唱：河南广播电视台音乐广播  闫婷婷</p>
