<template>
  <div class="player">
    <video-player v-show="isShow" ref="videoPlayer" class="vjs-custom-skin" :playsinline="true" :options="playerOptions" @ready="playerReadied">
    </video-player>
  </div>
</template>
    ...
    data() {
        return {
            ...
            playerOptions: {
                sources: [
                    {
                        ...
                        // src: "http://stream.hndt.com/live/jiaoyu/playlist.m3u8",
                        src: "http://live.muzhifm.com/shuazhibo/room322_pc.m3u8?auth_key=1540792203-0-0-9d557cb06d2772c24ea9a06d638f0e0c",
                ...
                poster: "https://a.weixin.hndt.com/h5/1066/paylive/livePost.jpg"
            }
        }
    },
    computed: {
