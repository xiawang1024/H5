        ...
        <div class="g-body">
          ...
          <div class="info-wrap first ani" swiper-animate-effect="fadeInRight" swiper-animate-duration="1.2s" swiper-animate-delay="0.45s">
            ...
            <div class="avatar-wrap">
              <img src="./host-1.png" alt="" class="avatar ani" swiper-animate-effect="flipInY" swiper-animate-duration="1.25s" swiper-animate-delay="0.95s">
            </div>
