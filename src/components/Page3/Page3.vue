<template>
    <div class="host2">
        ...
        <div class="g-body">
          <div class="info-wrap ani" swiper-animate-effect="fadeInDown" swiper-animate-duration="1.2s" swiper-animate-delay="0.45s">

            <div class="text-wrap">
              <h3 class="name">男声合唱：《在太行山上》  </h3>
              <p class="desc">词：桂涛生  曲：冼星海</p>
              <p class="desc">演唱：河南歌舞演艺集团歌剧团合唱团</p>
          ...
          <div class="info-wrap ani" swiper-animate-effect="fadeInDown" swiper-animate-duration="1.2s" swiper-animate-delay="0.85s">
            ...
            <div class="text-wrap">
              <h3 class="name">男声独唱：《黄河颂》</h3>

              <p class="desc">词：光未然  曲：冼星海</p>
              <p class="desc">演唱：郑州大学音乐学院 </p>
              <p class="desc">青年男中音歌唱家  张森</p>
            </div>
            <div class="avatar-wrap">
              <img src="./host-2.png" alt="" class="avatar">
            </div>
          </div>
          <div class="info-wrap ani" swiper-animate-effect="fadeInDown" swiper-animate-duration="1.2s" swiper-animate-delay="1.25s">
            <div class="text-wrap">
              <h3 class="name">大提琴独奏：《太阳最红毛主席最亲》</h3>
            </div>
          </div>
        </div>
    </div>
