    ...
    <div class="page1">
        ...
        <div class="g-body">
          ...
          <div class="info-wrap second ani" swiper-animate-effect="fadeInLeft" swiper-animate-duration="1.2s" swiper-animate-delay="0.85s">
            ...
            <div class="avatar-wrap">
              <img src="./host-2.png" alt="" class="avatar ani" swiper-animate-effect="flipInX" swiper-animate-duration="1.25s" swiper-animate-delay="1.5s">
            </div>
          </div>
        </div>
    </div>
